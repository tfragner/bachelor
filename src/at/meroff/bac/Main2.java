...
public class Main2 extends JComponent {

    public static Set<Field> fields = new HashSet<>();
    ...
    public static void main(String[] args) {
        ...
        fields.stream()
                ...
                .forEach(field -> {
                    ...
                    /*System.out.print("Subject area intersects task area: ");
                    System.out.println(field.getRectangle(CardType.SUBJECT).intersects(field.getRectangle(CardType.TASK)));
                    System.out.println(field.getRectangleSize(CardType.SUBJECT));
                    System.out.println(field.getRectangleSize(CardType.TASK));
                    System.out.println(field.getOverlapPercentages(CardType.SUBJECT));
                    System.out.println(field.getAllVectors());
                    System.out.println(field.getAllVectors().size());*/
                    List<Vec2d> allVectors = field.getAllVectors();
                    List<Vec2d> filtered = new LinkedList<>();

                    allVectors.forEach(vec2d -> {
                        //System.out.println("Basisvektor: " + vec2d);
                        allVectors.forEach(vec2d1 -> {
                            if (!vec2d.equals(vec2d1)) {
                                ...
                                v2[0] = vec2d1.x - vec2d.x;
                                v2[1] = vec2d1.y - vec2d.y;
                                double degree = Math.toDegrees(Math.acos(Cosine.similarity(v1, v2)));
                                //System.out.println(Cosine.similarity(v1, v2));
                                if ((degree <= 5) || (175 <= degree && degree <= 185) || (355 <= degree && degree <= 360)) {
                                    //System.out.println("\t" + "Vergleichsvektor: " + vec2d1 + " --> " + (int)(degree));
                                    filtered.add(vec2d);
                                }
                            }
                        });
                    ...
                    Long mainVector = field.getMainVector();
                    //System.out.println(mainVector + " --- von --- " + field.getTasks().size());
                    //System.out.println("Verhältnis: " + ((double)mainVector/field.getTasks().size()));
                    ...
                    field.getSubjects()
                            .stream()
                            .forEach(card -> {
                                //System.out.println(field.findAllVectorsForSubject(card));
                            });

                    //System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
                    Set<Pair<Card, Set<Pair<Card, Vec2d>>>> vectorSummary = field.getVectorSummary();

                    vectorSummary.stream()
                            .forEach(cardSetPair -> {
                                System.out.println("####################");
                                System.out.println(field.getNearestTask((Subject)cardSetPair.getKey()));
                                System.out.print("Subject - ID: " +cardSetPair.getKey().id);

                                cardSetPair.getValue().stream()
                                        .filter(cardVec2dPair -> cardVec2dPair.getKey().equals(field.getNearestTask((Subject)cardSetPair.getKey())))
                                        .forEach(cardVec2dPair -> {

                                            System.out.print(" --> " + cardVec2dPair.getKey().id);


                                            cardSetPair.getValue().stream()
                                                    .filter(cardVec2dPair1 -> {return !cardVec2dPair.equals(cardVec2dPair1);})
                                                    .filter(cardVec2dPair1 -> {
                                                        double similarity = Cosine.similarity(cardVec2dPair.getValue(), cardVec2dPair1.getValue());
                                                        return 0.97 <= similarity && similarity <= 1.00;
                                                    }).forEach(cardVec2dPair1 -> System.out.print(" --> " + cardVec2dPair1.getKey().id));
        ...
        System.out.println("nicht vollständig eingeschlossen");
        fields.stream().filter(field -> !field.getRectangle(CardType.TASK).contains(field.getRectangle(CardType.SUBJECT)) && !field.getRectangle(CardType.SUBJECT).contains(field.getRectangle(CardType.TASK)))
                .forEach(field -> System.out.println(field.getName()));

        System.out.println("vollständig eingeschlossen");
        fields.stream().filter(field -> field.getRectangle(CardType.TASK).contains(field.getRectangle(CardType.SUBJECT)) || field.getRectangle(CardType.SUBJECT).contains(field.getRectangle(CardType.TASK)))
                .forEach(field -> System.out.println(field.getName()));
        System.exit(0);

        fields.stream()
                .filter(field -> !field.getRectangle(CardType.SUBJECT).intersects(field.getRectangle(CardType.TASK)))
                .forEach(field -> System.out.println(field.getName()));


        fields.stream()
                .forEach(field -> System.out.println(field.getAllVectors()));

        fields.stream()
                .forEach(field -> System.out.println(field.getRBasic()));
    }
    ...
    public static Field getField01() {
    ...
    public static Field getField02() {
        Field field = new Field();
    ...
    public static Field getField03() {
        Field field = new Field();
    ...
    public static Field getField04() {
        Field field = new Field();
        ...
        field.addCard(new Task(17, 783, 280, 800, 178, 994, 210, 977, 313));
    ...
    public static Field getField05() {
        Field field = new Field();
    ...
    public static Field getField06() {
        Field field = new Field();
    ...
    public static Field getField07() {
        Field field = new Field();
    ...
    public static Field getField08() {
        Field field = new Field();
    ...
    public static Field getField09() {
        Field field = new Field();
    ...
    public static Field getField10() {
        Field field = new Field();
    ...
    public static Field getField11() {
        Field field = new Field();
    ...
    public static Field getField12() {
        Field field = new Field();
    ...
    public static Field getField13() {
        Field field = new Field();
    ...
    public static Field getField14() {
        Field field = new Field();
    ...
    public static Field getField15() {
        Field field = new Field();
    ...
    public static Field getField16() {
        Field field = new Field();
    ...
    public static Field getField17() {
        Field field = new Field();
